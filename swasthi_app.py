...
api = create_api()#call api key

while True:
    user = api.get_user('b_swasthika')
    api.update_profile(name=f'SWASTHI|{follower_count(user)} ')
    print(f'Updating Twitter Name : SWASTHI|{follower_count(user)}')
